    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-golden-light hover:bg-golden-light/30",
        ),
        ...
        day_range_middle: "aria-selected:bg-golden-light/50 aria-selected:text-brown",
